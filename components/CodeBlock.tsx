...
const CodeBlock: React.FC<CodeBlockProps> = ({ title, code, onEdit }) => {
      ...
      <div className="flex justify-between items-center p-3 border-b border-gray-700">
        ...
        <div className="flex items-center gap-2">
            {onEdit && (
                <button
                    onClick={onEdit}
                    className="px-3 py-1 text-xs font-medium rounded-md transition-colors text-gray-200 bg-teal-600 hover:bg-teal-700"
